<template>
  <div class="container-1200">
    ...
    <p class="object-list">
      ...
      <label for="inputR">r:<input id="inputR" type="text" v-model="currentObject.size.radius"></label>
...
<script>
import ObjectSize from '@/components/ObjectSize'
import ObjectSize3D from '@/components/ObjectSize/ObjectSize3D'
